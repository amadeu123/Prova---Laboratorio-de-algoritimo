 ...
 */
public class clienteProvaQuestao2 {

    static String arquivo = "C:\\Users\\Dinopc\\Desktop\\coisas aleatorias\\file2.txt";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.print("Quantidade de vérticess de origem total do grafo:" + " ");
        ...
        carregarGrafosEmMemoria(grafo);

        //imprimir quantidade de vertices
        imprimir(grafo, numeroDeVertices, i);
    ...
    static void carregarGrafosEmMemoria(List[] grafo) throws FileNotFoundException {
        ligarGrafo(grafo);
        int contador = 0;
        Scanner input = new Scanner(new FileReader(arquivo));
        while (input.hasNext()) {
    ...
    static void imprimir(List[] grafo, int numeroDeVertices, int i) {
        int contador = 0;
        for (List grafo1 : grafo) {
            ++i;
